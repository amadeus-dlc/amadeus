...
(*                              (reducer :674). It is excluded on a        *)
...
(*                              govern.                                    *)
(*                                                                         *)
(*     NOTE: the FD (business-logic-model.md T2) states the exclusion       *)
(*     ground for all 7 as "does not change status/operation/issueNumber". *)
(*     That is accurate for 6 of them and inaccurate for repair-link,      *)
(*     which does assign issueNumber. The modelled set of 14 is unchanged;  *)
(*     only the stated ground is corrected here, to the argument above.    *)
(*                                                                         *)
