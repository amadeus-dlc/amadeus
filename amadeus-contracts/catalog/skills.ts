...
const phaseSkillFeedbackConditions = [
  {
    id: "FB001",
...
] as const satisfies SkillContract["feedbackConditions"];

export const skillContracts = [
  {
    skillId: "amadeus-ideation",
    skillName: "amadeus-ideation",
    sourcePaths: ["skills/amadeus-ideation/SKILL.md", ".agents/skills/amadeus-ideation/SKILL.md"],
    ...
    readBoundary: {
      allowed: [".amadeus/intents/**", ".amadeus/steering/**", ".amadeus/domain-map.md", ".amadeus/context-map.md", "関連 Issue"],
      prohibited: ["秘密情報", "対象外 workspace の成果物"],
    },
    writeBoundary: {
      allowed: [".amadeus/intents/<intent>/ideation/**", ".amadeus/intents/<intent>/state.json"],
      prohibited: ["実装コード", "Inception 成果物", "Construction 成果物", "merge 操作"],
    },
    delegation: {
      allowed: [
        { skillId: "amadeus-ideation-intent-capture", purpose: "Intent Record を作成または補修する。" },
        { skillId: "amadeus-ideation-scope-framing", purpose: "scope を整理する。" },
        { skillId: "amadeus-ideation-feasibility-shaping", purpose: "実現可能性を整理する。" },
        { skillId: "amadeus-ideation-mock-framing", purpose: "初期 mock を整理する。" },
        { skillId: "amadeus-ideation-traceability-finalization", purpose: "追跡と状態を確定する。" },
      ],
      order: [
      ...
      prohibited: ["amadeus-construction"],
    },
    grillingConditions: [
      {
        id: "GR001",
    ...
    feedbackConditions: phaseSkillFeedbackConditions,
    consumerReferences: commonConsumerReferences,
  },
  {
    skillId: "amadeus-inception",
    skillName: "amadeus-inception",
    sourcePaths: ["skills/amadeus-inception/SKILL.md", ".agents/skills/amadeus-inception/SKILL.md"],
    generatedReferencePaths: [
    ...
    readBoundary: {
      allowed: [".amadeus/intents/<intent>/ideation/**", ".amadeus/steering/**", ".amadeus/domain-map.md", ".amadeus/context-map.md", "関連 Issue"],
      prohibited: ["Construction の実装差分を根拠にした要求改変"],
    },
    writeBoundary: {
      allowed: [".amadeus/intents/<intent>/inception/**", ".amadeus/intents/<intent>/state.json"],
      prohibited: ["実装コード", "Construction 成果物", "merge 操作"],
    },
    delegation: {
      allowed: [
        { skillId: "amadeus-inception-codebase-analysis", purpose: "既存コード分析を行う。" },
        { skillId: "amadeus-inception-requirements-definition", purpose: "要求と受け入れを定義する。" },
        { skillId: "amadeus-inception-user-stories", purpose: "必要な User Story を定義する。" },
        { skillId: "amadeus-inception-use-cases", purpose: "Use Case を定義する。" },
        { skillId: "amadeus-inception-units-generation", purpose: "Unit と Bolt を生成する。" },
        { skillId: "amadeus-inception-traceability-finalization", purpose: "追跡と状態を確定する。" },
      ],
      order: [
  ...
  },
  {
    ...
    sourcePaths: ["skills/amadeus-construction/SKILL.md", ".agents/skills/amadeus-construction/SKILL.md"],
    generatedReferencePaths: [
    ...
    readBoundary: {
      allowed: [".amadeus/intents/<intent>/inception/**", ".amadeus/intents/<intent>/construction/**", "対象実装コード", "対象テストコード", "関連 Issue/PR"],
      prohibited: ["対象外 Intent の成果物を根拠にした実装変更"],
    },
    writeBoundary: {
      allowed: [".amadeus/intents/<intent>/construction/**", ".amadeus/intents/<intent>/state.json", "対象 Task に対応する実装コード", "対象 Task に対応するテストコード"],
      prohibited: ["Spec 成果物", "Bolt 側 design.md", "merge 操作"],
    },
    delegation: {
      allowed: [
        { skillId: "amadeus-construction-functional-design", purpose: "Functional Design を作成する。" },
        { skillId: "amadeus-construction-bolt-preparation", purpose: "Task と notes を作成する。" },
        { skillId: "amadeus-construction-implementation-execution", purpose: "Task に対応する実装を行う。" },
        { skillId: "amadeus-construction-verification-hardening", purpose: "検証と test-results を作成する。" },
        { skillId: "amadeus-construction-traceability-finalization", purpose: "追跡と状態を確定する。" },
      ],
      order: [
      ...
      prohibited: ["amadeus-inception-requirements-definition"],
    },
    grillingConditions: [
      {
        id: "GR001",
  ...
  },
  {
    ...
    readBoundary: {
      allowed: [".amadeus/**", "skills/amadeus-validator/validator/generated/**", "検証対象の関連成果物"],
