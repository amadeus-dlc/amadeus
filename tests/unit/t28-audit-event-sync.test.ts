...
//   .sh test 7 (assert_eq TS_COUNT - baseline pin)    -> "VALID_EVENT_TYPES.size === 90 (baseline pin)"
...
// +INTENT_COMPLETION_TRANSACTION_COMMITTED (#2067) takes it to 90.
...
describe("t28 audit event-type sync (migrated from t28-audit-event-sync.sh, plan 7)", () => {
  ...
  test("VALID_EVENT_TYPES.size === 90 (baseline pin) [.sh test 7]", () => {
