...
const RAW_ALLOWLIST = [
  ...
  // U1 (otel-walking-skeleton, FR-DST-1): the vendored OTel dist files carry
  // their own upstream autogen header pointing at the OTel repo's build script
  // ("autogenerated file, see scripts/version-update.js"). That reference is
  // upstream's, not ours — allowlist it only inside vendored trees.
  { id: "vendored-otel-autogen-header", fileGlob: "**/vendor/**", pattern: "scripts/version-update\.js" },
