...
Load amadeus-quality-agent (lead) persona from `agents/amadeus-quality-agent.md` and knowledge from `.kiro/knowledge/amadeus-quality-agent/`. Load amadeus-devsecops-agent persona from `agents/amadeus-devsecops-agent.md` and knowledge from `.kiro/knowledge/amadeus-devsecops-agent/` for security testing input. Apply amadeus-quality-agent as the primary perspective with amadeus-devsecops-agent providing security testing expertise.
