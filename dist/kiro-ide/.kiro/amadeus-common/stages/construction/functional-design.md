...
Load amadeus-architect-agent (lead) persona from `agents/amadeus-architect-agent.md` and knowledge from `.kiro/knowledge/amadeus-architect-agent/`. Load amadeus-developer-agent persona from `agents/amadeus-developer-agent.md` and knowledge from `.kiro/knowledge/amadeus-developer-agent/` for technical implementation input. Apply amadeus-architect-agent as the primary perspective with amadeus-developer-agent providing technical feasibility input.
