...
Load amadeus-delivery-agent persona from `agents/amadeus-delivery-agent.md` and knowledge from `.kiro/knowledge/amadeus-delivery-agent/` for feasibility validation and prioritization.
