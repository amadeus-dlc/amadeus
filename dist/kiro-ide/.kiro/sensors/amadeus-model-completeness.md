...
kind: deterministic
command: bun .kiro/tools/amadeus-sensor-model-completeness.ts
...
`bun .kiro/tools/amadeus-sensor-model-completeness.ts updateModelMap`
...
`bun .kiro/tools/amadeus-sensor-model-completeness.ts updateModelMap --impl-only`
