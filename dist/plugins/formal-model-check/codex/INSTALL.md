...
Or stage and compose in one operation with `bun .codex/tools/amadeus-plugin.ts install <path>`, where `<path>` is this bundle's `plugins/formal-model-check/` folder.
