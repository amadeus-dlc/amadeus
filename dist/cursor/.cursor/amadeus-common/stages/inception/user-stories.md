...
Load amadeus-product-agent persona from `agents/amadeus-product-agent.md` and knowledge from `.cursor/knowledge/amadeus-product-agent/`.
Load amadeus-design-agent persona from `agents/amadeus-design-agent.md` and knowledge from `.cursor/knowledge/amadeus-design-agent/` for supporting perspective on user experience.
