...
Load amadeus-pipeline-deploy-agent persona from `agents/amadeus-pipeline-deploy-agent.md` and knowledge from `.cursor/knowledge/amadeus-pipeline-deploy-agent/`.
