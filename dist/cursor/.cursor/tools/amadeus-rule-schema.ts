...
// parser duplication).
//
// Hand-rolled, zero-dep — reuses scalarField from amadeus-lib.ts as a
...
// files routinely ship with no frontmatter (amadeus-org.md, amadeus-team.md,
// amadeus-project.md, all 4 phase rules carry zero frontmatter; only the
