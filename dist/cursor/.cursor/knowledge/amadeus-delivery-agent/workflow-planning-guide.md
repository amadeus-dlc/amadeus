...
Domain-specific guidance for the Workflow Planning stage. Use this alongside `.cursor/knowledge/amadeus-product-agent/product-guide.md` when leading execution plan creation.
