...
kind: deterministic
command: bun .opencode/tools/amadeus-sensor-model-completeness.ts
...
`bun .opencode/tools/amadeus-sensor-model-completeness.ts updateModelMap`
...
`bun .opencode/tools/amadeus-sensor-model-completeness.ts updateModelMap --impl-only`
