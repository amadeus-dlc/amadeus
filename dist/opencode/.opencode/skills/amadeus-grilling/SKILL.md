...
<!-- Adapted from Matt Pocock's "grilling" skill (mattpocock/skills, MIT) — see the attribution header in .opencode/amadeus-common/protocols/grilling-protocol.md -->
...
`.opencode/amadeus-common/protocols/grilling-protocol.md` (§1 Dialogue
