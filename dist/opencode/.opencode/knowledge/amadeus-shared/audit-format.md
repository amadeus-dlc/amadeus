...
| `PRACTICES_AFFIRMED` | Team approved practices at the practices-discovery affirmation gate; content promoted to `.opencode/amadeus-rules/amadeus-team.md` and `.opencode/amadeus-rules/amadeus-project.md` | Timestamp, affirming user, sections written, mandated/forbidden rules appended | `tools/amadeus-state.ts` `practices-promote` |
