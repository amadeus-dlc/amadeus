...
```
bun .opencode/tools/amadeus-worktree.ts info --slug <kebab-slug>
```
...
- Implementation: `.opencode/tools/amadeus-worktree.ts` (`handleInfo` handler)
- Test: `tests/unit/t72-worktree-info.sh`
- Caller: `.opencode/skills/amadeus/SKILL.md` (per-Bolt-loop halt-and-ask flow)
...
- Audit-format spec: `.opencode/knowledge/amadeus-shared/audit-format.md` `WORKTREE_CREATED` row
