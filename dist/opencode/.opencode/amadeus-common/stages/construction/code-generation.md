...
- **Standard strategy**: Requirement- and risk-driven unit tests plus integration tests for key boundaries, with E2E, performance, security, or other test types when applicable NFRs require them; 8 tests per component is a planning ceiling, not a quota
- **Comprehensive strategy**: Requirement-, risk-, and NFR-driven unit + integration + E2E tests, plus performance and security tests when required by applicable NFRs; 15 tests per component is a planning ceiling, not a quota
