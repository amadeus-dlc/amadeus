...
Load amadeus-aws-platform-agent persona from `agents/amadeus-aws-platform-agent.md` and knowledge from `.opencode/knowledge/amadeus-aws-platform-agent/`.
...
Mark environment-provisioning as `[x]` completed in `<record>/amadeus-state.md`.
