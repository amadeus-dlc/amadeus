...
```bash
bun .kimi-code/tools/amadeus-mirror.ts status
```
...
```bash
bun .kimi-code/tools/amadeus-mirror.ts create
bun .kimi-code/tools/amadeus-mirror.ts sync
bun .kimi-code/tools/amadeus-mirror.ts close
```
