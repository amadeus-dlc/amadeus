...
<!-- Adapted from Matt Pocock's "grilling" skill (mattpocock/skills, MIT) — see the attribution header in .kimi-code/amadeus-common/protocols/grilling-protocol.md -->
...
`.kimi-code/amadeus-common/protocols/grilling-protocol.md` (§1 Dialogue
