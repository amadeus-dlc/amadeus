...
Load amadeus-pipeline-deploy-agent persona from `agents/amadeus-pipeline-deploy-agent.md` and knowledge from `.kimi-code/knowledge/amadeus-pipeline-deploy-agent/`.
