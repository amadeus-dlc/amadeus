...
// `validateDirective` mirrors amadeus-stage-schema.ts: a ValidationResult union,
...
export interface RunStageDirective {
  ...
  // amadeus-orchestrate.ts emitPerUnitRunStage.
  unit?: string;
...
// amadeus-stage-schema.ts VALID_MODES (the directive's mode is read straight off
...
// unknown key (mirrors amadeus-stage-schema.ts KNOWN_FIELDS). `kind` is always
...
export const directiveSelfCheckExamples: Directive[] = [
    ...
    },
    {
      ...
      consumes: ["amadeus-docs/construction/auth/functional-design/functional-design.md"],
      ...
      stage_file: ".claude/amadeus-common/stages/construction/code-generation.md",
