...
compatibility: Requires bun; the CLI is bundled at .codex/tools/amadeus-election.ts.
---
...
```
bun .codex/tools/amadeus-election.ts open --file <definition.json>
```
...
```
bun .codex/tools/amadeus-election.ts next --election <id>
```
