...
<!-- Adapted from Matt Pocock's "grilling" skill (mattpocock/skills, MIT) — see the attribution header in .codex/amadeus-common/protocols/grilling-protocol.md -->
...
`.codex/amadeus-common/protocols/grilling-protocol.md` (§1 Dialogue
