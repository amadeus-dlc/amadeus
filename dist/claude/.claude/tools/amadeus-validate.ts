 ...
 * 1. Simple CSV paths: `amadeus-docs/.../file.md, amadeus-docs/.../file2.md`
 * 2. Directory + parens: `amadeus-docs/dir/ (file.md, file2.md, ...)`
...
function parseOutputs(outputsLine: string): string[] {
  ...
  // e.g., "amadeus-docs/dir/ (file.md, file2.md)" or "(9 artifacts: file.md, ...)"
  const parenRegex = /\(([^)]+)\)/g;
