...
- Read team practices via `.claude/rules/amadeus-team.md` (fall back to `org.md` per `knowledge/amadeus-shared/rules-reading.md`); match the affirmed branching strategy to one of the five in `branching-strategies.md`
...
4. `.claude/rules/` -- team-affirmed practices (read per `knowledge/amadeus-shared/rules-reading.md`)
