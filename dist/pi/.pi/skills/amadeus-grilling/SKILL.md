...
<!-- Adapted from Matt Pocock's "grilling" skill (mattpocock/skills, MIT) — see the attribution header in .pi/amadeus-common/protocols/grilling-protocol.md -->
...
`.pi/amadeus-common/protocols/grilling-protocol.md` (§1 Dialogue
