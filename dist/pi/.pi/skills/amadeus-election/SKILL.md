...
compatibility: Requires bun; the CLI is bundled at .pi/tools/amadeus-election.ts.
---
...
```
bun .pi/tools/amadeus-election.ts open --file <definition.json>
```
...
```
bun .pi/tools/amadeus-election.ts next --election <id>
```
