...
kind: deterministic
command: bun .pi/tools/amadeus-sensor-model-completeness.ts
...
`bun .pi/tools/amadeus-sensor-model-completeness.ts updateModelMap`
...
`bun .pi/tools/amadeus-sensor-model-completeness.ts updateModelMap --impl-only`
