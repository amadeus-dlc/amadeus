...
Load amadeus-delivery-agent persona from `agents/amadeus-delivery-agent.md` and knowledge from `.pi/knowledge/amadeus-delivery-agent/`.
...
**If practices-discovery executed**, read `.pi/rules/amadeus-team.md` via `extractMarkdownSection` for three sections that influence Bolt planning:
