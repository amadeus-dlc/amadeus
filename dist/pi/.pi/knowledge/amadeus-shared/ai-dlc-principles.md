...
3. **Traceable artifacts** — Every stage produces versioned markdown documents in `amadeus-docs/`, creating a complete decision record.
...
Not every task requires all 32 stages. Scopes (enterprise, feature, mvp, poc, fix, refactor, infra, security-patch, workshop) determine which stages execute and at what depth.
