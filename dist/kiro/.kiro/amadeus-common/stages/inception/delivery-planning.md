...
Load amadeus-delivery-agent persona from `agents/amadeus-delivery-agent.md` and knowledge from `.kiro/knowledge/amadeus-delivery-agent/`.
...
**If practices-discovery executed**, read `.kiro/steering/amadeus-team.md` via `extractMarkdownSection` for three sections that influence Bolt planning:
