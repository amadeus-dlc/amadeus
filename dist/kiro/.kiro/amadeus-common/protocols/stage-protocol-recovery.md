...
- Load `.kiro/steering/amadeus-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `.kiro/steering/amadeus-org.md` for greenfield default suggestions
