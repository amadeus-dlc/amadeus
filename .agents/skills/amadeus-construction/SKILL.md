...
description: >-
  ...
  Intent の bolts/*/notes.md、test-results.md、pr.md、tasks.md、acceptance.md、traceability.md、decisions、state.json を
...
| 内部 skill | プロセス | 主な結果 |
|---|---|---|
| `amadeus-construction-bolt-preparation` | Bolt 実行準備 | 対象 Bolt、Task、前提、作業順序、検証入口の確認、`notes.md` |
...
質問総数は最大4つにする。
既存の Inception 成果物、Bolt、Task、作業ツリー、テスト入口から分かることは質問しない。
