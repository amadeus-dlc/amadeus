...
description: >
  ...
  detection. Fix a specific bug. Packaging over `/amadeus --scope bugfix`, which works
  without this skill.
...
1. `directive = bun .agents/amadeus/tools/amadeus-orchestrate.ts next --scope bugfix $ARGUMENTS`
