...
export const stageCatalog: readonly StageDef[] = [
  ...
  { slug: "intent-capture", phase: "ideation", perUnit: false, scopes: [...businessScopes, "poc", "pdm"], requiredArtifacts: ["ideation/intent-capture/intent-statement.md", "ideation/intent-capture/stakeholder-map.md"] },
  { slug: "market-research", phase: "ideation", perUnit: false, scopes: ["enterprise", "feature", "pdm"], requiredArtifacts: ["ideation/market-research/competitive-analysis.md", "ideation/market-research/market-trends.md", "ideation/market-research/build-vs-buy.md"] },
  { slug: "feasibility", phase: "ideation", perUnit: false, scopes: [...businessScopes, "pdm"], requiredArtifacts: ["ideation/feasibility/feasibility-assessment.md", "ideation/feasibility/constraint-register.md", "ideation/feasibility/raid-log.md"] },
  { slug: "scope-definition", phase: "ideation", perUnit: false, scopes: [...businessScopes, "pdm"], requiredArtifacts: ["ideation/scope-definition/scope-document.md", "ideation/scope-definition/intent-backlog.md"] },
  ...
  { slug: "rough-mockups", phase: "ideation", perUnit: false, scopes: [...businessScopes, "pdm"], requiredArtifacts: ["ideation/rough-mockups/wireframes.md", "ideation/rough-mockups/user-flow.md"] },
  { slug: "approval-handoff", phase: "ideation", perUnit: false, scopes: ["enterprise", "feature", "pdm"], requiredArtifacts: ["ideation/approval-handoff/initiative-brief.md", "ideation/decisions.md", "ideation/traceability.md"] },
  ...
  { slug: "requirements-analysis", phase: "inception", perUnit: false, scopes: [...inceptionScopes, "poc", "bugfix", "refactor", "infra", "pdm"], requiredArtifacts: ["inception/requirements-analysis/requirements.md"] },
  { slug: "user-stories", phase: "inception", perUnit: false, scopes: [...inceptionScopes, "pdm"], requiredArtifacts: ["inception/user-stories/stories.md", "inception/user-stories/personas.md", "inception/user-stories/user-stories-assessment.md"] },
  { slug: "refined-mockups", phase: "inception", perUnit: false, scopes: [...inceptionScopes, "pdm"], requiredArtifacts: ["inception/refined-mockups/mockups.md", "inception/refined-mockups/interaction-spec.md", "inception/refined-mockups/design-system-mapping.md", "inception/refined-mockups/accessibility-checklist.md"] },
