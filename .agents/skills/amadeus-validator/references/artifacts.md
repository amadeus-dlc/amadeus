...
- `.amadeus/intents/<intent-id>-<slug>/ideation/traceability.md`
- `.amadeus/intents/<intent-id>-<slug>/ideation/decisions.md`
- `.amadeus/intents/<intent-id>-<slug>/ideation/mocks/`
- `.amadeus/intents/<intent-id>-<slug>/inception/requirements.md`
- `.amadeus/intents/<intent-id>-<slug>/inception/acceptance.md`
- `.amadeus/intents/<intent-id>-<slug>/inception/user-stories.md`
- `.amadeus/intents/<intent-id>-<slug>/inception/use-cases.md`
...
Initialized 段階では、`Intent のモジュールファイル` と `state.json` 以外の後続成果物の ID 実在チェックは行わない。
...
- `construction.bolts[].designGate.evidence` は対象 Bolt の `construction/bolts/<bolt-id>-<slug>/design.md` を指す。
...
- `construction.bolts[].tasks.evidence` は対象 Bolt の `construction/bolts/<bolt-id>-<slug>/tasks.md` を指す。
...
Construction 段階の `construction/bolts/<bolt-id>/design.md` は、次の見出しを持つ。
...
- `.amadeus/intents/<intent-id>-<slug>/inception/domain/bounded-contexts/<bounded-context-id>-<slug>/models.md`
...
- `.amadeus/intents/<intent-id>-<slug>/inception/domain/bounded-contexts/<bounded-context-id>-<slug>/models/<ddd-module-id>-<slug>.md`
