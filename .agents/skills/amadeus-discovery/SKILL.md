...
description: >-
  ...
  `.amadeus/discoveries/<discovery-id>/brief.md`、`state.json` を作成または補修する場面では必ず使う。
...
1. `.amadeus/settings/templates/discoveries/discovery/`
2. この skill に同梱された `templates/discoveries/discovery/`
...
| `詳細` | `[brief.md](discoveries/<discovery-id>/brief.md)` |
