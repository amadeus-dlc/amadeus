...
```bash
bun .codex/tools/amadeus-mirror.ts status
```
...
```bash
bun .codex/tools/amadeus-mirror.ts create
bun .codex/tools/amadeus-mirror.ts sync
bun .codex/tools/amadeus-mirror.ts close
```
