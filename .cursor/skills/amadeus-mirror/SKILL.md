...
```bash
bun .cursor/tools/amadeus-mirror.ts status
```
...
```bash
bun .cursor/tools/amadeus-mirror.ts create
bun .cursor/tools/amadeus-mirror.ts sync
bun .cursor/tools/amadeus-mirror.ts close
```
