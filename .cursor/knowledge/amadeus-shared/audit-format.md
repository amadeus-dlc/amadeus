...
| `PRACTICES_AFFIRMED` | Team approved practices at the practices-discovery affirmation gate; content promoted to `.cursor/amadeus-rules/amadeus-team.md` and `.cursor/amadeus-rules/amadeus-project.md` | — | Affirming User, Sections Written, Mandated Rules Appended, Forbidden Rules Appended, Timestamp | `tools/amadeus-state.ts` `practices-promote` |
