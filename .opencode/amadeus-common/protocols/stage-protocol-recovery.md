...
- Load `.opencode/amadeus-rules/amadeus-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `.opencode/amadeus-rules/amadeus-org.md` for greenfield default suggestions
