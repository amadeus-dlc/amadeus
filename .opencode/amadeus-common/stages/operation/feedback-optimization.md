...
Load amadeus-operations-agent persona from `agents/amadeus-operations-agent.md` and knowledge from `.opencode/knowledge/amadeus-operations-agent/`.
...
Mark feedback-optimization as `[x]` completed in `<record>/amadeus-state.md`.
