...
Load amadeus-pipeline-deploy-agent persona from `agents/amadeus-pipeline-deploy-agent.md` and knowledge from `.opencode/knowledge/amadeus-pipeline-deploy-agent/`.
...
Mark deployment-execution as `[x]` completed in `<record>/amadeus-state.md`.
