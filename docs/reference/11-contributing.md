...
core/                             # Compatibility alias to packages/framework/core/
harness/                          # Compatibility alias to packages/framework/harness/
