...
[Knowledge](08-knowledge.ja.md) を参照してください。
...
供給されるかについては [Rules and the Learning Loop](09-rules-and-the-learning-loop.ja.md) を
参照してください。
...
[CLI Commands](12-cli-commands.ja.md) を参照してください。
...
| **Grill Me** | 設計ツリーをラウンド単位でインタビュー、推奨回答付き — ツリーに入ったすべての分岐が決着するまで |
...
ステージごとの完全な入力表については、[Orchestration Reference](../reference/00-overview.ja.md) を参照してください。
...
- [State Tracking and Audit Trail](10-state-and-audit.ja.md) — 状態ファイルと監査証跡の詳細
- [How a Stage Runs](04-phases-and-stages.ja.md) — ステージ実行と成果物生成
- [Glossary](glossary.ja.md) — 成果物、フェーズ境界検証、質問ファイルの定義
