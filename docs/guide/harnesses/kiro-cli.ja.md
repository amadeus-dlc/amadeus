...
> [Kiro IDE で AI-DLC を実行する](kiro-ide.md) で文書化されています。
...
[新しいハーネスへの移植](../../harness-engineering/09-porting-to-a-new-harness.md) を参照。
...
他のハーネス: [Codex CLI 上の AI-DLC](codex-cli.md) · [ハーネスファミリーの索引](README.md)。
