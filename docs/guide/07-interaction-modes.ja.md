...
harness ごとの実際の見え方は、[question-rendering annex](../../skills/amadeus/references/question-rendering.md) が定義する。例えば Codex では選択肢として 3 つが並び、Chat は専用の選択肢ではなく自由記述（custom）から到達する。
