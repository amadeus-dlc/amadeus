...
各 stage の実行モードは、その stage 定義（frontmatter）が宣言し、stage ごとの一覧は [Stage Catalog](../../core/skills/amadeus/references/stage-catalog.md) が持つ。
...
stage 一覧の全体は [Stage Catalog](../../core/skills/amadeus/references/stage-catalog.md) を参照する。
