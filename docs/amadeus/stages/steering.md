...
Steering は、Ideation、Inception、Construction へ進む前に、workspace 全体で共有する目的、方針、知識、用語、アクター、外部システム、ドメイン境界、Discovery 一覧、Intent 一覧をそろえる基盤である。

`amadeus-steering` は、この steering layer を greenfield または brownfield で作成、点検、補修する公開入口である。

## Responsibility

`amadeus-steering` は、複数 Intent で共有する成果物だけを扱う。
...
|---|---|---|---|---|---|
| S.1 | Steering Layer Preparation | CONDITIONAL | `.amadeus/` がない、または steering layer の点検、補修が必要な場合 | `amadeus-steering` | `.amadeus/README.md`、`steering.md`、`steering/**`、`glossary.md`、`domain/**`、`discoveries.md`、`intents.md` |
...
| `.amadeus/domain/**` | 全体の Domain Model |
