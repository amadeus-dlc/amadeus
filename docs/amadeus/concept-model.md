...
`.amadeus/domain/bounded-contexts/<bounded-context-id>-<slug>/models.md` は、境界づけられたコンテキスト内の DDD Module 一覧を扱う。

`.amadeus/domain/bounded-contexts/<bounded-context-id>-<slug>/models/<ddd-module-id>-<slug>.md` は、コンテキスト別の概念間の関係、ライフサイクル、集約候補を扱う DDD Module のモジュールファイルである。

`.amadeus/domain/bounded-contexts/<bounded-context-id>-<slug>/contracts.md` は、コンテキスト別の事前条件、不変条件、事後条件を扱う。

Intent 固有のサブドメイン、境界づけられたコンテキスト、概念関係、契約を固定する場合は、Intent 配下に `domain/subdomains.md`、`domain/bounded-contexts.md`、`domain/bounded-contexts/<bounded-context-id>-<slug>/models.md`、`domain/bounded-contexts/<bounded-context-id>-<slug>/models/<ddd-module-id>-<slug>.md`、`domain/bounded-contexts/<bounded-context-id>-<slug>/contracts.md` を置く。

`domain/bounded-contexts.md` は、Unit を切る時に参照するコンテキスト、責務、外部境界、コンテキスト間の Upstream/Downstream、組織パターン、統合パターンを扱う。

`domain/bounded-contexts/<bounded-context-id>-<slug>/contracts.md` は、事前条件、不変条件、事後条件を扱う。
