...
[skill-language-policy.md](skill-language-policy.md) は、Amadeus skill のソース（`skills/amadeus*/` および `.agents/skills/amadeus*/` 配下の `SKILL.md` と TypeScript スクリプト）の言語を扱う。
