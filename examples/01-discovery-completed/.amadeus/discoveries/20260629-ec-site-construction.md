...
|---|---|---|---|---|---|---|
| 販売管理の最小購入フロー | recommended | 未初期化 | 商品選択から注文作成までの最小購入フローを先に切り出す。範囲は、商品選択、販売可能在庫の確認、購入者情報の記録、注文内容確認、注文作成である。 | 購入者が商品を選び、販売可能在庫を確認し、購入者情報と注文内容を記録して注文を作成できる範囲が Intent 化されている。 | 会員登録、ログイン、顧客台帳、購入履歴管理、決済詳細、売上確定、在庫引当、入荷、棚卸し、出荷。 | 商品情報公開の詳細は未初期化だが、最小購入フロー内で商品選択に必要な前提だけを扱う。 |
