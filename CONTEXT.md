...
Intent 配下の `inception/domain/bounded-contexts/BC001-authentication-access/models/DM001-account.md` に置く。

**Intent Bounded Context**：特定の Intent で Unit を切る時に参照する境界づけられたコンテキスト、責務、外部境界である。
Intent 配下の `inception/domain/bounded-contexts.md` に置く。

**Intent Contracts**：特定の Intent で守る事前条件、不変条件、事後条件と根拠を扱う文書である。
Intent 配下の `inception/domain/bounded-contexts/BC001-authentication-access/contracts.md` に置く。
...
正式化された内容は、対象範囲に応じて Intent 配下の `inception/domain/bounded-contexts.md`、`inception/domain/bounded-contexts/BC001-authentication-access/models/DM001-account.md`、`inception/domain/bounded-contexts/BC001-authentication-access/contracts.md`、または `.amadeus/domain/` に昇格する。
