...
Intent 配下の `domain/bounded-contexts/BC001-authentication-access/models/DM001-account.md` に置く。
...
正式化された内容は、対象範囲に応じて Intent 配下の `domain/bounded-contexts.md`、`domain/bounded-contexts/BC001-authentication-access/models/DM001-account.md`、`domain/bounded-contexts/BC001-authentication-access/contracts.md`、または `.amadeus/domain/` に昇格する。
