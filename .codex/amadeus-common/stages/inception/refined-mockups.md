...
Load amadeus-design-agent persona from `agents/amadeus-design-agent.md` and knowledge from `.codex/knowledge/amadeus-design-agent/`.
...
Create mid-to-high fidelity mockups (per user story/screen), interaction specification document (use `.codex/knowledge/amadeus-design-agent/component-spec-template.md` as the format for component-level specifications), design system mapping, responsive behavior specification, and accessibility compliance checklist.
