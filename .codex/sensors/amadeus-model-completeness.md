...
kind: deterministic
command: bun .codex/tools/amadeus-sensor-model-completeness.ts
...
`bun .codex/tools/amadeus-sensor-model-completeness.ts updateModelMap`
...
`bun .codex/tools/amadeus-sensor-model-completeness.ts updateModelMap --impl-only`
