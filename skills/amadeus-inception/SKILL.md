...
既存の `Intent 正本ファイル`、`scope.md`、`ideation.md`、`traceability.md`、`decisions.md`、steering layer、domain layer から分かることは質問しない。
...
`Intent 正本ファイル`、`scope.md`、`ideation.md` は原則として既存内容を尊重する。
...
`Intent 正本ファイル`、`scope.md`、`ideation.md`、steering layer、domain layer を読み、次を確認する。
