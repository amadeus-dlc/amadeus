...
- `tasks.md` は同じ Bolt の `bolt.md` と参照先 Unit `design.md` を入力にし、Task の `作業`、`要求`、`ユースケース`、`依存`、`証拠` を省略しない。
...
| `task-generation-review-gate` | 完了 | `tasks.md` を書く前に `bolt.md`、参照先 Unit `design.md`、要求、ユースケースを確認し、gap があれば書かずに止める。 | `/var/folders/3s/p2xl_vd524b4lk78cb6fz5nh0000gn/T/amadeus-inception-eval.20260627-hgfmNl/task-generation-review-gate/checks.md` |
...
| `brownfield-codebase-analysis-gate` | 完了 | brownfield では Unit、Unit `design.md`、Bolt の前に既存コード分析を通し、traceability に入力を残す。 | `/var/folders/3s/p2xl_vd524b4lk78cb6fz5nh0000gn/T/amadeus-inception-eval.20260627-hgfmNl/brownfield-codebase-analysis-gate/checks.md` |
