...
- Intent 固有のモデルと契約は `.amadeus/intents/<intent-id>-<slug>/inception/domain/**` に反映する。
...
| `promote-intent-model-element` | 完了 | Intent 側 domain model と `inception/traceability.md` だけを更新し、全体昇格は明示がある場合に限る。 | `/tmp/amadeus-domain-modeling-eval.766VOu/promote-intent-model-element/repo` |
