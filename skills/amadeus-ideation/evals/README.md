...
| init 不足 | 完了 | Intent Recordが不足している場合は成果物を作らず、`amadeus-ideation` を案内して止める。 | `/tmp/amadeus-ideation-init-missing.mErktj/init-missing-eval-output.md` |
