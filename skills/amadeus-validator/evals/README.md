...
- `amadeus-state.md` では、scope、depth、Project Type、Status、Lifecycle Phase、State Version、Stage Progress の checkbox と scope の実行対象の一致、Phase Progress、Current Stage、`audit/audit.md` のイベント、completed ステージの必須成果物を検証する。
