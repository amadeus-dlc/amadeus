...
| `construction-design-ready` | 完了 | Design Gate ready 時点で `design.md`、Bolt 単位 gate、`Construction Design からの追跡` がある。 | `examples/04-construction-design-ready` が `pass`。一時コピーで `Logical Design` 本文、Bolt gate、設計追跡を壊すと `fail`。 |
