...
`Domain Design`、`Logical Design`、`実装設計`、`検証設計` では、対象 Bolt の全 Task を `B001/T001` の形式で明示する。

Design Gate が `ready` または `passed` の場合、`Construction Design からの追跡` は Design Gate evidence と同じ `design.md` を指す。
