...
description: >-
  ...
  `.amadeus/event-storming/<event-storming-id>/` または
...
- `.amadeus/event-storming/*/summary.md`
- `.amadeus/event-storming/*/state.json`
- `.amadeus/intents/*/event-storming/*/summary.md`
...
1. `.amadeus/settings/templates/event-storming/session/`
...
既存の Domain Event や候補を上書きする場合は、理由を `hotspots.md` または `summary.md` の `Supersession` に残す。
...
`summary.md` の `Supersession` に、`Supersedes`、`Superseded By`、`Reason` を残す。
