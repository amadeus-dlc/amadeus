...
All stages follow `amadeus-common/protocols/stage-protocol.md` for approval gates, question format, and completion messages. Structured questions render per `question-rendering.md` beside this file — `request_user_input` when the tool is available, numbered prose options otherwise (D-3 two-track).
