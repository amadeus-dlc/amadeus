...
| 260703-amadeus-skill-english-rollout-plan | Amadeus skill の英語化を、小さい土台 PR から段階的に進める実施計画として管理する。 GitHub Issue #399 を親タスクとして扱い、#395、#400、#401、#402 の順序、依存関係、完了境界、完了状態を追跡できる状態にする。 | 260703-aidlc-v2-full-compliance | [260703-amadeus-skill-english-rollout-plan.md](260703-amadeus-skill-english-rollout-plan.md) |
