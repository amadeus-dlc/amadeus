# Unit Test Instructions：B009 Ideation and supporting skills 英語化

## 対象

B009 は Ideation stage の 7 skill と補助分析・review 系の 7 skillの `SKILL.md` 翻訳と、契約検査・provenance の整合更新である。
