# Build Instructions：B009 Ideation and supporting skills 英語化

## 目的

Ideation stage の 7 skill と補助分析・review 系の 7 skillの `SKILL.md` 英語化について、翻訳後の契約検査、昇格同期、Amadeus DLC 成果物の構造を確認する。
