# Unit Test Instructions：B006 Core entrypoints and verification 英語化

## 対象

B006 は amadeus、amadeus-steering、amadeus-validator の 3 skillの `SKILL.md` 翻訳と、契約検査・provenance の整合更新である。
