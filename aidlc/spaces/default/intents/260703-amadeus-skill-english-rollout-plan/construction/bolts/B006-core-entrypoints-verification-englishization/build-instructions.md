# Build Instructions：B006 Core entrypoints and verification 英語化

## 目的

amadeus、amadeus-steering、amadeus-validator の 3 skillの `SKILL.md` 英語化について、翻訳後の契約検査、昇格同期、Amadeus DLC 成果物の構造を確認する。
