...
| B003 | #401 AI-DLC v2 差分対応順序 Bolt | U003 | 3 | no | #401 の対応 PR merge または明示的な Issue close を確認できる。#391、#392、#393、#394 の扱いを #401 の完了証拠として追跡できる。 | AI-DLC v2 差分対応順序を確定し、#401 配下 Issue を親 Intent の直接完了条件へ広げずに扱える。 |
