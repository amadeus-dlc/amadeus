...
| U003 | #401 AI-DLC v2 差分対応順序 | 英語化後の AI-DLC v2 差分対応順序を整理し、#391、#392、#393、#394 の扱いを #401 の計画証拠として追跡する。 | R001、R002、R003、R004 | PB003 |
| U004 | #402 残り展開単位 | 残り Amadeus skill の段階的英語化単位を決める。 | R001、R002、R004 | PB004 |
...
| U010 | #399 最終検証 | Amadeus 系 `SKILL.md` の全面英語化、昇格先同期、検証結果、Issue #399 の完了条件を確認する。 | R005、R006 | PB008 |
