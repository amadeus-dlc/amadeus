...
| C002 | 完了証拠管理 | 子 Issue ごとの PR merge または明示的な Issue close を完了証拠として扱う。 | R002、R005 |
| C003 | #401 配下 Issue 扱い管理 | #391、#392、#393、#394 の扱いを #401 の完了証拠として保持する。 | R003 |
| C004 | skill 英語化 PR 境界管理 | 翻訳変更、意味変更、昇格フロー、検証結果の境界を PR 判断材料として保持する。 | R004 |
| C005 | 親 Issue 完了判断 | #395、#400、#401、#402 の完了証拠から #399 の完了判断可否を示す。 | R005 |
...
| C003 | Intent の requirements、delivery-planning、traceability | #401 の完了証拠に内包する。 |
