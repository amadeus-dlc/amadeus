...
## D003：#401 配下 Issue は #401 の計画証拠として扱う

### 判断

#391、#392、#393、#394 の扱いは、#401 の計画証拠として扱う。

### 根拠

Scope Definition と Requirements Analysis で、#391、#392、#393、#394 の個別完了は B005 以降の残タスクとして追跡すると定義した。

### 影響

親 Issue 完了判断は、#395、#400、#401、#402、#391〜#394、RU002〜RU006、最終検証の完了証拠を入力にする。
