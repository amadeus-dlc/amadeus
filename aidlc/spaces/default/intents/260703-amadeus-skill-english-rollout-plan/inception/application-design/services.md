...
| SV002 | 完了証拠確認サービス | GitHub 上の PR merge、Issue close、対象外判断、英語化検証結果を完了証拠として扱う。 | C002、C003 |
| SV003 | PR 境界確認サービス | skill 英語化 PR の変更範囲、昇格フロー、検証結果を確認する。 | C004 |
| SV004 | 親 Issue 完了判断サービス | 子 Issue、差分対応、全面英語化、最終検証の完了証拠から #399 の完了判断可否を示す。 | C005 |
