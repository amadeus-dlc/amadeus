...
| PB003 | #401 AI-DLC v2 差分対応順序 | Must | PB002 | 対応 PR の merge または明示的な Issue close | #391〜#394 の扱いを完了証拠として追跡する。 |
| PB004 | #402 残り展開単位 | Must | PB003 | 対応 PR の merge または明示的な Issue close | 残り skill の段階的英語化単位を決める。 |
| PB005 | #391〜#394 の個別完了 | Nice | PB003 | 未確認 | #401 の完了証拠として扱い、この Intent の直接完了条件にはしない。 |
| PB006 | 残り skill 英語化の詳細 PR 計画 | Nice | PB004 | 未確認 | #402 の成果物で扱う。 |
