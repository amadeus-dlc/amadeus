...
```bash
bun .claude/tools/amadeus-mirror.ts status
```
...
```bash
bun .claude/tools/amadeus-mirror.ts create
bun .claude/tools/amadeus-mirror.ts sync
bun .claude/tools/amadeus-mirror.ts close
```
