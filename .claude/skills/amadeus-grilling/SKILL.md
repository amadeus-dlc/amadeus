...
<!-- Adapted from Matt Pocock's "grilling" skill (mattpocock/skills, MIT) — see the attribution header in .claude/amadeus-common/protocols/grilling-protocol.md -->
...
`.claude/amadeus-common/protocols/grilling-protocol.md` (§1 Dialogue
