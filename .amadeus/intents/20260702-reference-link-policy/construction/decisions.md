...
| D004 | validator で検出する PR記録欠落と PRリンク形式を固定する。 | active | D003 | [D004-validation-boundary.md](decisions/D004-validation-boundary.md) |
...
| D004 | D003 | validator の検出境界は、適用成果物範囲を前提にするため。 |
