...
| UC003 | ACT002 Agent | なし | なし | R002, R004 | UC001, UC002 | [UC003-execute-and-integrate-wave.md](use-cases/UC003-execute-and-integrate-wave.md) |
...
| UC003 | UC001, UC002 | 並行実行は wave 分割と承認済みの Task が前提になるため。 |
