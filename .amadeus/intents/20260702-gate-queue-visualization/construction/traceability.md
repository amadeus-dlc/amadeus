...
| [tasks.md](bolts/B002-skill-procedure-and-promotion/tasks.md) | B002/T001, B002/T002 | `skills/amadeus-validator/SKILL.md` と昇格先 | [test-results.md](bolts/B002-skill-procedure-and-promotion/test-results.md) | 未作成 | passed | B002/T002 は promote 同期の内部作業であり、アクターとの相互作用がないためユースケースを参照しない。 |
