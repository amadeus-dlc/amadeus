...
`.amadeus/` 過去分析と学習分類の内部 skill を追加する。

## 依存

| 依存 | 理由 |
|---|---|
| 20260701-feedback-learning-loop | Issue #277 は、Issue #259 の学習分類契約を内部 skill として具体化し、Issue #272 の dry-run が過去分析結果を入力にできる前提を作るため。 |
