...
| D004 | PR #287 の merge を Construction 完了証拠と遡及承認として採用する。 | active | D001, D002, D003 | [D004-pr-287-merge-finalization.md](decisions/D004-pr-287-merge-finalization.md) |
...
| D004 | D001, D002, D003 | 完了確定は、分類、metadata 実装、後続分離のすべてが merge されたことを前提にするため。 |
