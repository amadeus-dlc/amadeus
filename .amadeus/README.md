...
`Inception への入力` には、ユニット、ボルト、`design.md`、`tasks.md` へ渡す判断材料を書く。
...
タスクは、同じボルトの `bolt.md` と `design.md` を入力にして作る。
`design.md` がない状態で `tasks.md` を作らない。
...
- `design.md` の責務境界、構成、データと契約、検証方針、`Task への入力` がタスクに反映されている。
...
| `bolts/<bolt-id>/design.md` | 必須 | ボルト作成後、タスク作成前 | ボルト内の責務境界、構成、データと契約、検証方針、Task への入力を扱う | タスクを作らない間は作らない |
| `bolts/<bolt-id>/tasks.md` | 必須 | ボルト設計後 | タスクを識別子付きチェックリストで扱う。入力は同じボルトの `bolt.md` と `design.md` | ボルトがなければ作らない |
...
- [ ] Unit、Bolt、`design.md`、`tasks.md` へ渡す入力を記録した。
