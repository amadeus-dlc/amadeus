...
export const INSTALLER_CHANGE_RULES: InstallerChangeRule[] = [
  ...
  { id: "source-core", pattern: "core/", scope: "source-dist", reason: "distribution source changed" },
  { id: "source-harness", pattern: "harness/", scope: "source-dist", reason: "harness source changed" },
