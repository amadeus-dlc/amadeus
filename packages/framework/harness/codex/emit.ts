...
export default function emit(ctx: EmitContext): EmitResult {
  ...
  for (const skill of ["amadeus-session-cost", "amadeus-replay", "amadeus-outcomes-pack", "amadeus-grilling", "amadeus-mirror"]) {
