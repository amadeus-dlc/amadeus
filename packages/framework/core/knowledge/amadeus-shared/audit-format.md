...
| `PRACTICES_AFFIRMED` | Team approved practices at the practices-discovery affirmation gate; content promoted to `{{HARNESS_DIR}}/rules/amadeus-team.md` and `{{HARNESS_DIR}}/rules/amadeus-project.md` | Timestamp, affirming user, sections written, mandated/forbidden rules appended | `tools/amadeus-state.ts` `practices-promote` |
