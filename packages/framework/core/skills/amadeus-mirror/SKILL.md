...
```bash
bun {{HARNESS_DIR}}/tools/amadeus-mirror.ts status
```
...
```bash
bun {{HARNESS_DIR}}/tools/amadeus-mirror.ts create
bun {{HARNESS_DIR}}/tools/amadeus-mirror.ts sync
bun {{HARNESS_DIR}}/tools/amadeus-mirror.ts close
```
