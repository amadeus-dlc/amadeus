...
id: type-check
kind: deterministic
command: bun {{HARNESS_DIR}}/tools/amadeus-sensor-type-check.ts
...
`amadeus-docs/.amadeus-sensors/<stage-slug>/type-check-<fire-id>.md` (Fire id is the 8-hex correlator from the SENSOR_FIRED audit row) containing
