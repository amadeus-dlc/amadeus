...
Load amadeus-delivery-agent persona from `agents/amadeus-delivery-agent.md` and knowledge from `{{HARNESS_DIR}}/knowledge/amadeus-delivery-agent/` for feasibility validation and prioritization.
