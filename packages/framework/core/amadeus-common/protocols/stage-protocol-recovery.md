...
- Load `{{HARNESS_DIR}}/rules/amadeus-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `{{HARNESS_DIR}}/rules/amadeus-org.md` for greenfield default suggestions
