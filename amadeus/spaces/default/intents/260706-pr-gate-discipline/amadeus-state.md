...
## Project Information
- **Project**: Issue #534: PR gate 規律を「ルール = 不変条件 + ポインタ、知識 = 監視手順と判断基準」で Amadeus に移設する（個人 CLAUDE.md 依存の解消）
- **Project Type**: Brownfield
- **Scope**: refactor
- **Start Date**: 2026-07-06T01:08:14Z
- **State Version**: 7
...
- **Last Updated**: 2026-07-06T02:24:51Z
