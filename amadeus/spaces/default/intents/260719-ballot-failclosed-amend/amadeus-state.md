...
## Project Information
- **Project**: 選挙 CLI の ballot 受理境界を fail-closed 化する: (1) Issue #1252 — Ballot.parse に submittedAt の様式検証を追加(regex+Date の二段検証、NaN にならない ISO 風文字列の落ちる実証を含む) (2) Issue #1253 — amend ballot の提出経路を新設(vote verb の kind:amend 対応、tally 側 amend 解決規則の設計裁定込み)。修正面は scripts/amadeus-election-*.ts 系+テスト。
...
- **Worktree Path**:
- **Bolt Refs**: ballot-acceptance-failclosed
...
- **Next Stage**: none
- **Status**: Running
- **Last Updated**: 2026-07-20T00:49:37Z
