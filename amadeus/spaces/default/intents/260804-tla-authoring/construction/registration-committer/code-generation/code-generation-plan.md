...
上流入力(consumes 全数): U4 の functional-design(business-logic-model.md / business-rules.md / domain-entities.md)と nfr-design(security-design.md / logical-components.md)、`bolt-plan.md` Bolt 5 節、`requirements.md` FR-010 前後。
...
6. CLI: `tla-authoring.ts` へ commit verb を FLAT_COMMANDS 様式で追加
