...
4. **U3引継ぎ受入**: warm cacheを準備後、Docker実containerでwarm-up 1回+計測5回を実行する。各計測のspawn/CLI時間、outcome、manifest/receipt digest検証結果をartifactへ保存し、1回でもexit非0、spawn 180秒以上、CLI 180秒以上、artifact不整合ならformal jobを失敗させる。
