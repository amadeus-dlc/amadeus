...
- BR-U5-7(コア供給): manifest は .claude/sensors/amadeus-model-completeness.md、実装はコア tools 配置(通常3手順)。graph compile の sensor id 検証(unknown id loud reject)に登録される — U2 の compile 前提
