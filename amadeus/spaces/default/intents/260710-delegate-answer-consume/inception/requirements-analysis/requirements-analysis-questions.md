...
[Answer]: A(選挙 2026-07-10、4票 e1/e2/e4/e6。種別スコープ消費 — 発行意図と消費先の一致、ローカル意味論(QA=HUMAN_TURN 消費、t188)不変)
...
[Answer]: A(選挙 2026-07-10、4票。1 delegate = 1 answer + 1 gate のトラック別 consume-once — anti-autopilot 維持、実運用実績とも一致)
...
[Answer]: A(選挙 2026-07-10、4票。消費側のみ修正。発行側 grounding は実測事故ゼロのため surgical に現状維持、必要時に別 Issue)
