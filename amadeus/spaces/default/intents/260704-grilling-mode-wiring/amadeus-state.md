...
## Project Information
- **Project**: Issue #442: ステージ質問に amadeus-grilling が発火しない結線欠落を修正する。mode 選択に Grill me を 2 番目で挿入し（Guide me / Grill me / I'll edit the file / Chat の 4 択）、question-rendering annex を正規フックとして結線し、29 ステージ skill の矛盾文言を一括置換で揃え、結線を守る決定論的 wiring 検査を dev-scripts に追加する。
- **Project Type**: Greenfield
- **Scope**: bugfix
- **Start Date**: 2026-07-04T12:03:32Z
- **State Version**: 7
...
- **Last Updated**: 2026-07-04T12:56:08Z
