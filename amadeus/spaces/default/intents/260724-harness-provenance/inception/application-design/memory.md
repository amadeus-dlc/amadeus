...
## Interpretations
- 2026-07-24T17:30:47Z — 既存harnessDir(): stringを互換維持し、内部HarnessDirResolutionで検出元を保持; 実検出.claudeとfallback .claudeを区別してAC-3cのunknownを実装可能にするため、ユーザー確認後にFunctional Designから後方ジャンプした
...
## Deviations
- 2026-07-24T17:30:47Z — 旧レビューREADY後にAC-3c実装不能を実コード照合で発見; harnessDir()がfallback provenanceを失う事実を旧設計・レビューが見落としていたため、ADR-5とprovenance-aware resolverを追加して再レビューする
