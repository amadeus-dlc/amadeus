...
## Project Information
- **Project**: 選挙の仕組みをノルムで支えるのではなくtsで基盤を作り、SKILLで薄くラップする。これについて、ideationだけやりたい。最後にissueに同期したい。scripts/amadeus-mirror.ts。やりとりはここであなたと私で。質問は私に
- **Project Type**: Brownfield
- **Scope**: amadeus
- **Start Date**: 2026-07-18T23:14:07Z
- **State Version**: 7
- **Active Agent**: amadeus-quality-agent
- **Worktree Path**:
- **Bolt Refs**: [cli-complete, skill-wrap]
...
- **Next Stage**: none
- **Status**: Running
- **Last Updated**: 2026-07-19T11:32:32Z
