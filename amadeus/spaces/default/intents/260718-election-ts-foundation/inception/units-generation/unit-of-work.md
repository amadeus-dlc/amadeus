...
| U5 election-cli | next/report 指令ループ(7状態機械 — requirements.md FR-0/ADR-3 追補(E-ETF-FD2 Q2=A、申告付き同期))+全 verb 配線+機械実行器 e2e(ADR-6 CI 層) | C6 | scripts/amadeus-election.ts+e2e テスト | L | 200-280 / 200-300 行 |
