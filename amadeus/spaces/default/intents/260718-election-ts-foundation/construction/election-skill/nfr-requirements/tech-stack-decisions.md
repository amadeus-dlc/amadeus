...
| 領域 | 選定 | 根拠 |
|---|---|---|
| SKILL 配置 | `contrib/skills/amadeus-election/SKILL.md` | ADR-1(U-01=B 裁定)+requirements.md FR-8a の contrib overlay 実測(promote-self.ts:45-46)。amadeus-upstream-sync 前例(SKILL.md+references のみ)と同型 |
