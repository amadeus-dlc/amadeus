...
- 対象はチーム内選挙(requirements.md FR-1a の投票者集合)。現登録は 14 名(`team.sh amadeus` 実行出力、2026-07-19 実測・stage diary 記録)で、W-04(配布外)によりユーザー数成長の前提を持たない — スケーリング戦略・容量計画は N/A(反証可能な根拠: scope-document W-04+ADR-2 の space ローカル記録)
