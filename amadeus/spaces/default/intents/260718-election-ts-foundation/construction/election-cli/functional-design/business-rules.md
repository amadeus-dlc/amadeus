...
| BR-C2 | hold 指令は人間への提示文を含み、AI 側で自動解決する経路がない | C-01、FR-4b | hold 4理由の指令生成+自動遷移の不在 assert |
| BR-C3 | report は現状態と result の不整合を reject(fail-closed) | FR-0 | 不整合5ケースの reject |
