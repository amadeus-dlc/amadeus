...
## Project Information
- **Project**: AMADEUS_USE_SWARMを段階的に廃止し、AMADEUS_SWARM_DRIVERを新設する。Claude CodeのTask・Dynamic Workflow・Agent Team、Codexのcodex exec・native multi-agent（Ultra対応）、Kiroのsubagentを明示的なdriver契約で選択できるようにし、auto選択、互換性、loud degradation、監査イベント、ドキュメント、テストを実装する
- **Project Type**: Brownfield
- **Scope**: amadeus
- **Start Date**: 2026-07-13T04:25:12Z
- **State Version**: 7
- **Active Agent**: amadeus-developer-agent
- **Worktree Path**:
- **Bolt Refs**:
- **Practices Affirmed Timestamp**: 2026-07-13T08:21:13Z
...
## Workspace State
- **Project Root**: /Users/j5ik2o/.codex/worktrees/d9c7/amadeus
...
- **Status**: Running
- **Last Updated**: 2026-07-15T11:24:43Z
