# technology-stack — 260706-feature-diff

正本は [codekb/amadeus/technology-stack.md](../../../../codekb/amadeus/technology-stack.md)（増分更新 2026-07-06T07:58:00Z、基準 commit b452f4fb。本 Intent の reverse-engineering で鮮度確認・必要分のみ更新）である。本ファイルは参照台帳として重複記述を避ける。
