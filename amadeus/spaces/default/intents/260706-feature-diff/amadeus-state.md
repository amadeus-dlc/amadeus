...
## Project Information
- **Project**: Issue #524: 上流 aidlc-workflows（main / v2 基準 commit b67798c3）と Amadeus の機能差一覧を docs/amadeus に新設する（英語 *.md + 日本語 *.ja.md）。比較軸・出典実測・追従手順は Issue 記載のとおり
- **Project Type**: Brownfield
- **Scope**: refactor
- **Start Date**: 2026-07-06T07:53:41Z
- **State Version**: 7
...
- **Last Updated**: 2026-07-06T08:29:56Z
