# api-documentation — 260705-engine-installer

正本は [codekb/amadeus/api-documentation.md](../../../../codekb/amadeus/api-documentation.md)（解析時刻 2026-07-05T12:25:00Z、解析基準 3049eadf、PR #496）である。本ファイルは参照台帳として重複記述を避ける。
