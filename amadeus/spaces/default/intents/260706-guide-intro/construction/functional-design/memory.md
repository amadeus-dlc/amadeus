...
- 2026-07-06T08:30:00Z — 設計段階で実測の先行採取を行った（installer の実行・doctor・intent-birth）。導入直後の doctor 1 fail が初回 workflow の shell seed で解消する実挙動を発見し、Issue #573 として起案・起票済み。ガイドには正直な記載 + #573 の pending 注記を書く。
