...
- [x] Step 3: en/ja 表を同期(4行追加: nfr-budget / question-budget / scope-sizing / git-drift。model-completeness 行は投影済み注記へ更新)→ Green。`grep -c '^| \`amadeus-'` = 14 を en/ja 両方で実測 → FR-3 (1)(2)
