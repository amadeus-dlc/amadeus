# api-documentation — 260705-persist-cid-metamain

正本は [codekb/amadeus/api-documentation.md](../../../../codekb/amadeus/api-documentation.md)（増分更新 2026-07-05T23:25:37Z、基準 commit 616d063e、本 Intent の reverse-engineering で更新）である。本ファイルは参照台帳として重複記述を避ける。
