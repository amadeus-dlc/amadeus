# reverse-engineering-timestamp — 260706-harness-codex

正本は [codekb/amadeus/reverse-engineering-timestamp.md](../../../../codekb/amadeus/reverse-engineering-timestamp.md)（増分更新 2026-07-06T05:44:48Z = Intent 260706-engine-consistency による同範囲更新を正とし、本 Intent の reverse-engineering は鮮度確認 + 残存旧名 1 行の補正のみ実施）である。本ファイルは参照台帳として重複記述を避ける。
