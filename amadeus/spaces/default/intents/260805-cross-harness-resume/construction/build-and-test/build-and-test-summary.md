...
- **integration**: integration-test-instructions.md の7ファイル(新規 t451/t452/t453+既存 t365/t-kimi-adapter/t416/t-coverage-mechanism-ratchet)— 焦点 run+フルスイートで green
...
1. **coverage 正規判定は PR CI**(`cid:code-generation:local-lcov-pre-push`)— waiver 2件除去(t451 が in-process driver)の被覆確定を PR の Patch/Project Coverage Gate で行う
