...
## Project Information
- **Project**: Issue #921 残余: metrics/*.json snapshot 群(46件蓄積中)の時系列を読む定点観測コマンドを実装する — collector 別の時系列テーブル/サマリ出力(md/tsv)、schema_version 互換、既存 metrics-snapshot.ts と対の閲覧面
- **Project Type**: Brownfield
- **Scope**: amadeus
- **Start Date**: 2026-07-16T21:02:29Z
- **State Version**: 7
...
- **Status**: Running
- **Last Updated**: 2026-07-16T22:14:00Z
