...
## Project Information
- **Project**: このツールはインストーラがありません。利用者が簡単にインストールできるインストーラがほしい。
...
## Scope Configuration
- **Stages to Execute**: 0.1, 0.2, 0.3, 1.1, 1.2, 1.3, 1.4, 1.7, 2.1, 2.2, 2.3, 2.4, 2.6, 2.7, 2.8, 3.1, 3.2, 3.3, 3.4, 3.5, 3.6, 3.7, 4.1, 4.2, 4.3
...
- **Status**: Running
- **Last Updated**: 2026-07-08T13:13:10Z
