# Market Trends — インストーラの実装(installer-distribution)

> ステージ: market-research (Ideation) / 作成: 2026-07-08
> 上流入力: `../intent-capture/intent-statement.md`
> 出典: 前 intent の 2026-07-07 出典付き調査を `market-research-questions.md` Q1/Q2 で再確認の上で採用
...
shadcn/ui CLI v4 は「もはや単なるインストーラではなく、プロジェクト状態を管理する洗練されたツール」へ進化した(出典: [shadcn/ui March 2026 Update](https://medium.com/@nakranirakesh/shadcn-ui-march-2026-update-cli-v4-ai-agent-skills-and-design-system-presets-d30cf200b0e9))。導入後の状態(バージョン、カスタマイズ)を認識する CLI がトレンドであり、「バージョン検出 + 差分レポート」はこの潮流に合致する。
...
- 差別化は更新体験(差分レポート + 非破壊マージ)に集中させる(`market-research-questions.md` Q2 で確定した戦略配分)
