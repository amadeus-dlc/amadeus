...
| 2回目 | 変異コピー(LICENSE を files から除去) | missing 検出+**列挙の厳密一致**(ワークスペース非依存前提の実証を兼ねる — reliability-design) | ≤8秒+コピー I/O ≤2秒 |
| 3回目 | 変異コピー(契約外ファイルを files へ追加) | unexpected 検出+同上の厳密一致 | ≤8秒+コピー I/O ≤2秒 |
