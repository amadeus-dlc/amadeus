...
> 出典: ADR-002/003、build-vs-buy、NFR-005、codekb `technology-stack.md`、`../functional-design/business-logic-model.md`(fetch/extract/manifest ワークフローの実装手段)・`business-rules.md`(BR-F05 SemVer 正規化・BR-F12 スキーマ検査を実装する標準 API の選定)
