...
## Project Information
- **Project**: Bolt worktree 実行契約と並行運用 policy の整理・補強: #407（Bolt worktree 実行契約と Intent 単位並行 policy のズレ整理）と #342（walking skeleton 相当の不在と Bolt 切り直し手順の未明文化）を、2026-07-05 の複数セッション並行運用で観察した実例（primary 占有の調整、stop hook 誤督促、意味的接触の申し送り、指示系統の委任）を根拠に文書へ反映する
- **Project Type**: Greenfield
- **Scope**: refactor
- **Start Date**: 2026-07-05T08:09:25Z
- **State Version**: 7
...
- **Last Updated**: 2026-07-05T08:48:10Z
