# component-inventory — 260706-model-overlay

正本は [codekb/amadeus/component-inventory.md](../../../../codekb/amadeus/component-inventory.md)（増分更新 2026-07-06T00:25:00Z、基準 commit 2a0a784b）である。本ファイルは参照台帳として重複記述を避ける。
