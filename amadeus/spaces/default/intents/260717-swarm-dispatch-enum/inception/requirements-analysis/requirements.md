...
- C-13/C-14 live evidence — ユーザー裁定により新規 Codex セッションが probe を実施予定(手順書 = `<record>/inception/requirements-analysis/c13-probe-procedure.md`)。結果は本書 FR-5 と evidence 添付で閉じる
