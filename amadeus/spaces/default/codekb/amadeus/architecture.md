...
> **2026-07-25 更新（intent `260725-kimi-harness`、現在）**: base `6d4df90566dcf7aa00980e5f9e85c831ca9108ba` → observed HEAD `d31b8a5db5798ef761f3871ca66824c87530afb4`（distance 105）の differential refresh（amadeus-feature）。交差面は plugin 出荷モデルの中立バンドル化、ハーネス検出の `amadeus-harness.ts` 分離、新ハーネス追加が触れる 3 閉集合の非対称。下記「plugin 中立バンドル出荷とハーネス移植面の 3 閉集合」節が current view。以下の 260724 系・260723 系節はいずれも履歴。

## plugin 中立バンドル出荷とハーネス移植面の 3 閉集合（260725-kimi-harness、現在）
