...
## 観測可能区間集計のアーキテクチャ（260809-cg-attribution-stats、現在、observed `82e2f30c0`）
...
## 監査 journal の v1/v2 二重スキーマとリーダー面の構造（260807-intent-2328-tests-e2e-au、履歴、observed `a5621236c`）
