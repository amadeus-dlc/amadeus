...
## Verification
- ALWAYS approval 前に produced artifact の canonical shape と sensor predicate を照合し、H2 を意図的に欠く "*-timestamp.md" と "*-questions.md" を prose-heading floor から明示的に免除する。 (learned 2026-07-20) <!-- cid:practices-discovery:e-fvepd-marker-heading-floor -->
