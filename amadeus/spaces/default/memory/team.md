...
- GitHub Issue はタイトル・本文・コメント(クロスレビュー verdict 含む)のすべてを日本語で書く。コード識別子・ファイルパス・コマンド・ログ引用・ラベル(bug/P0-P3 等)は原文のまま保持する (user decision 2026-07-10) <!-- cid:requirements-analysis:issues-in-japanese -->
