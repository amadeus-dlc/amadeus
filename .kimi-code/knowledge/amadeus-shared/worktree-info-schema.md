...
```
bun .kimi-code/tools/amadeus-worktree.ts info --slug <kebab-slug>
```
...
- Implementation: `.kimi-code/tools/amadeus-worktree.ts` (`handleInfo` handler)
- Test: `tests/unit/t72-worktree-info.sh`
- Caller: `.kimi-code/skills/amadeus/SKILL.md` (per-Bolt-loop halt-and-ask flow)
...
- Audit-format spec: `.kimi-code/knowledge/amadeus-shared/audit-format.md` `WORKTREE_CREATED` row
