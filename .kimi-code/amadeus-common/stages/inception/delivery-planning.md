...
Load amadeus-delivery-agent persona from `agents/amadeus-delivery-agent.md` and knowledge from `.kimi-code/knowledge/amadeus-delivery-agent/`.
...
**If practices-discovery executed**, read `.kimi-code/rules/amadeus-team.md` via `extractMarkdownSection` for three sections that influence Bolt planning:
