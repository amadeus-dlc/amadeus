...
description: >
  ...
  detection. Skip operations, ship the core. Packaging over `/amadeus --scope mvp`, which works
  without this skill.
...
1. `directive = bun .kimi-code/tools/amadeus-orchestrate.ts next --scope mvp $ARGUMENTS`
