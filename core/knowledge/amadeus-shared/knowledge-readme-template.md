...
> This table is a snapshot — the authoritative mapping lives in each agent's frontmatter at `{{HARNESS_DIR}}/agents/*.md`.
...
| `amadeus-compliance-agent/` | Compliance standards | data-governance.md, audit-requirements.md |
| `amadeus-aws-platform-agent/` | Cloud infrastructure | account-structure.md, service-limits.md |
| `amadeus-pipeline-deploy-agent/` | CI/CD configuration | pipeline-standards.md, deployment-gates.md |
| `amadeus-delivery-agent/` | Project management | sprint-cadence.md, definition-of-done.md |
