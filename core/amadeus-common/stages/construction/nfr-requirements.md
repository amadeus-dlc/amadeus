...
Load amadeus-architect-agent (lead) persona from `agents/amadeus-architect-agent.md` and knowledge from `{{HARNESS_DIR}}/knowledge/amadeus-architect-agent/`. Load amadeus-devsecops-agent persona from `agents/amadeus-devsecops-agent.md` and knowledge from `{{HARNESS_DIR}}/knowledge/amadeus-devsecops-agent/` for security requirements input. Load amadeus-compliance-agent persona from `agents/amadeus-compliance-agent.md` and knowledge from `{{HARNESS_DIR}}/knowledge/amadeus-compliance-agent/` for regulatory constraint mapping. Load amadeus-quality-agent persona from `agents/amadeus-quality-agent.md` and knowledge from `{{HARNESS_DIR}}/knowledge/amadeus-quality-agent/` for testable quality attribute scenarios. Apply amadeus-architect-agent as the primary perspective with amadeus-devsecops-agent, amadeus-compliance-agent, and amadeus-quality-agent providing specialist input.
