...
Load amadeus-design-agent persona from `agents/amadeus-design-agent.md` and knowledge from `{{HARNESS_DIR}}/knowledge/amadeus-design-agent/` for supporting perspective on user experience.
